...
<div class="<?php echo $classes; ?>" <?php echo $el_id;?>>
    <div class="filter-item-inner show-distance-filter nearby-inputs-wrap">
        <div class="nearby-input-wrap">
            ...
            <input id="<?php echo esc_attr( $autoplaceid ); ?>" name="location_search" type="text" placeholder="<?php echo esc_attr( $placeholder ); ?>" class="qodef-archive-places-search location-input auto-place-loc" value="<?php echo isset($_GET['location_search']) ? $_GET['location_search'] : ''; ?>"/>
        ...
        <?php if($enable_distance == 'yes'): 
            ...
            if( isset($_GET['distance']) && $_GET['distance'] != '' ) $dfdistance = $_GET['distance'];
        ...
        ?>
            ...
            <input type="hidden" class="address_lat auto-place-lat" name="address_lat" value="<?php echo isset($_GET['address_lat']) ? $_GET['address_lat'] : ''; ?>">
            <input type="hidden" class="address_lng auto-place-lng" name="address_lng" value="<?php echo isset($_GET['address_lng']) ? $_GET['address_lng'] : ''; ?>">
