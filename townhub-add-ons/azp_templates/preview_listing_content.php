...
$hide_contacts = $hide_view_map = $hide_gallery = $hide_footer = $show_price = $show_locations = $show_web = '';
...
<div class="<?php echo $classes; ?>" <?php echo $el_id;?>>
    ...
    <div class="geodir-category-content-title fl-wrap">
        <div class="geodir-category-content-title-item">
            ...
            <?php if( $hide_address != 'yes'): ?><div class="geodir-category-location fl-wrap"><a href="#" class="map-item"><i class="fas fa-map-marker-alt"></i><?php 
            ...
            <ul class="no-list-style mrg-0 dis-inflex">
                ...
                foreach ($terms as $term) {
                    ...
                    <li class="tolt"  data-microtip-position="top" data-tooltip="<?php echo esc_attr( $term->name ); ?>">
                        <a href="<?php echo esc_url( get_term_link( $term->term_id, 'listing_feature' ) ); ?>"><i class="<?php echo esc_attr( $term_metas['icon'] ); ?>"></i></a>
                    </li>
                    <?php
                    $count++;
                }
    ...
    <div class="geodir-category-footer fl-wrap dis-flex">
        ...
        <div class="geodir-opt-list dis-flex">
            <ul class="no-list-style">
                ...
                <?php if( $hide_view_map != 'yes' && townhub_addons_get_option('use_osm_map') !='yes' ): ?><li class="lcard-bot-map"><a href="#" class="map-item"><i class="fal fa-map-marker-alt"></i><span class="geodir-opt-tooltip"><?php _e( 'On the map', 'townhub-add-ons' ); ?></span> </a></li><?php endif; ?>
                <?php 
                if( $hide_gallery != 'yes'):
