...
$title = $showing = $max = $single_select =  '';  
// var_dump($azp_attrs);
extract($azp_attrs);
...
<div class="<?php echo $classes; ?>" <?php echo $el_id;?>>
	<div class="ajax-modal-details-box">
		...
		<div id="cth-availability-room"
	        ...
	        ></div>
	    <?php if( $single_select != 'yes' ) echo '<p class="ravaical-min-nights">'.sprintf(_nx( 'Requires a minimum stay of %d night', 'Requires a minimum stay of %d nights', $min_nights, 'minimum nights to book', 'townhub-add-ons' ), $min_nights ).'</p>'; ?>
	</div>
</div>