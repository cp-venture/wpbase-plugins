...
$hide_au_message = $hide_phone = $hide_web = $hide_whatsapp = $hide_address = '';
// var_dump($azp_attrs);
extract($azp_attrs);
            ...
            <div class="box-widget-content bwc-nopad">
                <div class="list-author-widget-contacts list-item-widget-contacts bwc-padside">
                    <ul class="no-list-style">
                        ...
                        <li class="aucontact-address"><span><?php _e( '<i class="fal fa-map-marker"></i> Address :', 'townhub-add-ons' );?></span> <a href="https://www.google.com/maps/search/?api=1&query=<?php echo esc_attr($latitude).','.esc_attr($longitude);?>" target="_blank"  rel="nofollow"><?php echo esc_html($address);?></a></li>
                        <?php endif;?>
                        <?php 
                        ...
                        <li class="aucontact-web"><span><?php _e( '<i class="fal fa-browser"></i> Website :', 'townhub-add-ons' );?></span> <a href="<?php echo esc_url( $website ) ;?>" target="_blank"  rel="nofollow"><?php echo  esc_url($website ) ;?></a></li>
                        <?php endif;?>
                        <?php 
                        if($phone != '' && $hide_whatsapp != 'yes' ): ?>
                        <li class="aucontact-whatsapp"><span><?php _e( '<i class="fab fa-whatsapp"></i> Whatsapp: ', 'townhub-add-ons' );?></span> <a href="<?php echo 'https://wa.me/'.$phone; ?>" target="_blank"  rel="nofollow"><?php echo esc_html($phone)  ;?></a></li>
                        <?php endif;?>
                    </ul>
                </div>
                <?php 
