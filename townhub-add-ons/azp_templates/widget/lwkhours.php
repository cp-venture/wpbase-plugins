    ...
    <div class="box-widget-item fl-wrap block_box">
        ...
        <div class="box-widget opening-hours fl-wrap">
            <div class="box-widget-content">
            	<span class="current-status"><i class="fal fa-clock"></i> <?php echo $working_hours['statusText'];?> <span class="listing-timezone"><?php echo $working_hours['timezone'];?></span></span>
                <?php 
