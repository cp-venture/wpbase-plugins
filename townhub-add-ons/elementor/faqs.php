                    ...
                    <div class="faq-links fl-wrap">
                        ...
                        <div class="post-nav-wrap fl-wrap">
                            <?php if ($settings['nhphone'] != ''): ?>
                                <a class="post-nav post-nav-prev<?php if( $settings['leftimage'] != '' ) echo ' post-nav-has-thumb'; ?>" href="#">
                            ...
                            <?php if ($settings['nhemail'] != ''): ?>
                                <a class="post-nav post-nav-next<?php if( $settings['rightimage'] != '' ) echo ' post-nav-has-thumb'; ?>" href="#">
