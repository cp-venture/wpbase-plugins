                    ...
                    <div class="<?php echo esc_attr($cls); ?>">
                        ...
                        <div class="price-content fl-wrap">
                            ...
                            <div class="price-desc fl-wrap">
                                ...
                                <?php else : ?>
                                <a href="#" class="price-link logreg-modal-open <?php echo esc_attr($btncls); ?>" data-message="<?php esc_attr_e( 'You must be logged in to order a membership plan.', 'townhub-add-ons' ); ?>"><?php echo sprintf(__( 'Choose %s', 'townhub-add-ons' ), get_the_title()); ?></a>
                                <?php endif; ?>
