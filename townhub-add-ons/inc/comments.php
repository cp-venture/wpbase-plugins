...
<?php if(comments_open( )) : ?>
    ...
    <div class="lsingle-block-box" id="lreviews_form">
        <?php
			...
			'must_log_in'=> '<div class="cm-must-log-in not-empty">' . __( 'You must be <a class="comment-log-popup logreg-modal-open" href="#">logged in</a> to post a comment.' ,'townhub-add-ons') . '</div>',
