                        ...
                        <div class="row lcheckout-row">
                            <div class="col-md-8 lcheckout-col-left">
                                ...
                                <div class="checkout-must-logged-in">
                                    ...
                                    <span class="must-logged-in-btn"><a href="#" class="btn-link logreg-modal-open"><?php _e( 'Login or register', 'townhub-add-ons' ); ?></a></span>
                                </div>
        ...
        <div class="cart-details_text">
            <ul class="cart-listi">
                ...
                <?php if (!empty($data['slots'])): ?>
                    <li class="clearfix bk-slots"><?php esc_html_e( 'Time Slots', 'townhub-add-ons' ); ?><div class="cart-dtright"><?php echo implode("<br />", $data['slots'] ); ?></div></li>
                <?php endif ?>
