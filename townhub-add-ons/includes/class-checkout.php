...
$count = 1;
    ...
    public function render_submit(){
        // $this->render_terms();
        ?>
        <button data-payment="<?php echo rawurlencode(json_encode($this->stripe_data)); ?>" class="btn color-bg lcheckout_btn" type="submit" id="lcheckout_btn"><span class="btn-text"><?php esc_attr_e('Place Order', 'townhub-add-ons');?></span><i class="fal fa-angle-right i-for-default"></i><i class="fa fa-spinner fa-pulse i-for-loading"></i></button>
