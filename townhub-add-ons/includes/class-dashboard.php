    ...
    public static function notification_entity($type = '')
    {
        $entities = array(
            ...
            'membership_will_expired'  => array(
                ...
                'noti_msg'          => _x( '<i class="fal fa-exclamation-triangle"></i> Your membership subscription will expire within 5 days. Please renew it.','Membership expired notification template', 'townhub-add-ons' ),
            ),

            'ad_will_expired'  => array(
                'entity_type_id'    => 21,
                'desc'              => 'AD will expire notification',
                'noti_msg'          => _x( '<i class="fal fa-exclamation-triangle"></i> Your AD for a listing will expire within 5 days.','AD will expire notification template', 'townhub-add-ons' ),
            ),

            'membership_expired'  => array(
                'entity_type_id'    => 22,
                'desc'              => 'Membership expired notification',
                'noti_msg'          => _x( '<i class="fal fa-exclamation-triangle"></i> Your membership subscription has expired. Please renew it.','Membership expired notification template', 'townhub-add-ons' ),
            ),
