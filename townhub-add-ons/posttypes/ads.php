...
function townhub_addons_elementor_listing_slider_ads($temp_args = array() ){
    if(townhub_addons_get_option('ads_home_enable') != 'yes') 
        return;

    $hide_status = isset($temp_args['hide_status']) ? $temp_args['hide_status'] : 'no';
...
add_action( 'townhub_addons_elementor_listing_slider_before', 'townhub_addons_elementor_listing_slider_ads' );
