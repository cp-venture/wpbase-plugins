        ...
        <table class="form-table cth-table table-invoice-details">
            <tbody>
                ...
                <tr>
                    ...
                    <td class="w20 text-right"><?php echo townhub_addons_get_price_formated(get_post_meta( $post->ID, ESB_META_PREFIX.'amount', true )); ?></td>
                </tr>
                <tr>
                    <td class="w40 text-right text-bold text-blur" colspan="2"><?php _e( 'Subtotal', 'townhub-add-ons' ); ?></td>
                    <td class="w40 text-right" colspan="3"><?php echo townhub_addons_get_price_formated(get_post_meta( $post->ID, ESB_META_PREFIX.'amount', true )); ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="w60 text-right text-bold" colspan="3"><?php echo townhub_addons_get_price_formated(get_post_meta( $post->ID, ESB_META_PREFIX.'amount', true )); ?></td>
                </tr>
            </tbody>
        </table>
        <?php   
