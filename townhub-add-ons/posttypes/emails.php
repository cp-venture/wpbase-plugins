        ...
        if ($is_editing_listing == false) {
            ...
            if (null != $listing_post) {
                ...
                if (townhub_addons_get_option('emails_auth_new_listing_enable') == 'yes') {
                    ...
                    $email_template = self::process_email_template(townhub_addons_get_option('emails_auth_new_listing_subject'), $temp_args);
                    $temp_args      = array(
                        'listing_number'    => $listing_post->ID,
                        'listing_author'    => $current_user->display_name,
                        'listing_title'     => $listing_post->post_title,
            ...
            if (null != $booking_post) {
                ...
                if (null != $listing_post) {
                    ...
                    $temp_args = array(
                        ...
                        'total'                 => get_post_meta($booking_id, ESB_META_PREFIX . 'price_total', true), 
                    ...
                    if (townhub_addons_get_option('emails_section_auth_booking_insert_enable') == 'yes') {
                        ...
                        // $email_template = townhub_addons_process_email_template(townhub_addons_get_option('emails_section_auth_booking_insert_temp'), $temp_args);
                        $email_template = self::process_email_template(townhub_addons_get_option('emails_section_auth_booking_insert_temp'), $temp_args);
                    ...
                    if (townhub_addons_get_option('emails_section_customer_booking_insert_enable') == 'yes' && $lb_email != '') {
                        ...
                        $email_template = self::process_email_template(townhub_addons_get_option('emails_section_customer_booking_insert_temp'), $temp_args);
            ...
            if (null != $booking_post) {
                ...
                if (null != $listing_post) {
                    ...
                    if (townhub_addons_get_option('emails_section_customer_booking_approved_enable') == 'yes' && $lb_email != '') {
                        ...
                        // $email_subject = townhub_addons_process_email_template(townhub_addons_get_option('emails_section_customer_booking_approved_subject'), $subj_args);
                        ...
                        // $email_template = townhub_addons_process_email_template(townhub_addons_get_option('emails_section_customer_booking_approved_temp'), $temp_args);
                        $email_template = self::process_email_template(townhub_addons_get_option('emails_section_customer_booking_approved_temp'), $temp_args);
