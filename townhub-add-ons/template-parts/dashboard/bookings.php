            ...
            if($posts_query->have_posts()) :
                ...
                <div id="booking-<?php the_ID(); ?>" <?php post_class('dashboard-card dashboard-booking-item'); ?>>
                    ...
                    <div class="dashboard-card-content">
                        ...
                        <?php $bkslots = get_post_meta( get_the_ID(), ESB_META_PREFIX.'slots', true ); 
                        if(!empty($bkslots)):
                        ?>
                        <div class="booking-details fl-wrap bktime-slots">
                            <span class="booking-title"><?php esc_html_e( 'Time Slots:', 'townhub-add-ons' ); ?></span>
                            <span class="booking-text"><?php echo implode("<br />", $bkslots ); ?></span>
                        </div>
                        <?php endif; ?>
