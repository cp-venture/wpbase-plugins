...
$show_counter = '';
$hide_status = '';
$hide_rating = $hide_cats = $hide_author = $hide_views = $hide_bookmarks = $hide_address = $hide_phone = $hide_email = '';
...
<div class="list-single-header-item  fl-wrap single-head-top flex-items-center">
	<div class="single-head-top-left">
        ...
        <div class="geodir-category-location fl-wrap">
        	<?php if( $hide_address != 'yes' && $address != '' ): ?><a href="#"><i class="fas fa-map-marker-alt"></i><?php echo esc_html($address); ?></a><?php endif; ?>
