                    ...
                    <div class="user-profile-header fl-wrap clearfix">
                        <div class="user-profile-header_media fl-wrap">
                            ...
                            <?php 
                                ...
                                <div class="follow-btn color2-bg logreg-modal-open" data-message="<?php esc_attr_e( 'Logging in first to follow author.', 'townhub-add-ons' ); ?>"><?php _e( 'Follow <i class="fal fa-user-plus"></i>', 'townhub-add-ons' ); ?></div>
                            <?php 
                            endif;?>
                        </div>
                ...
                <div class="col-md-4 author-single-sidebar">
                    ...
                    <div class="box-widget-item fl-wrap block_box">
                        <div class="box-widget-item-header">
                            <h3><?php _e( 'About Athor ', 'townhub-add-ons' ); ?></h3>
                        </div>
                            ...
                            <div class="box-widget-content">
                                ...
                                <form class="author-message-form custom-form" action="#" method="post">
                                    ...
                                    <fieldset>
                                        ...
                                        <input name="lmsg_name" class="has-icon" type="text" placeholder="<?php esc_attr_e( 'Your Name*', 'townhub-add-ons' ); ?>" value="" required="required">
                                        <div class="clearfix"></div>
                                        <label><i class="fal fa-envelope"></i></label>
                                        <input name="lmsg_email" class="has-icon" type="text" placeholder="<?php esc_attr_e( 'Email Address*', 'townhub-add-ons' ); ?>" value="" required="required">
                                        <label><i class="fal fa-phone"></i></label>
                                        <input name="lmsg_phone" class="has-icon" type="text" placeholder="<?php esc_attr_e( 'Phone', 'townhub-add-ons' ); ?>" value="">
