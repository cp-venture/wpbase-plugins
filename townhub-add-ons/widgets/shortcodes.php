        ...
        <div class="subscribe-form <?php echo esc_attr( $class ); ?>">
            ...
            <form class="townhub_mailchimp-form">
                ...
                <label class="subscribe-agree-label" for="subscribe-agree-checkbox">
                    <input id="subscribe-agree-checkbox" type="checkbox" name="sub-agree-terms" required="required" value="1"><?php _e( 'I agree with the <a href="#" target="_blank">Privacy Policy</a>', 'townhub-add-ons' ); ?>
                </label>
